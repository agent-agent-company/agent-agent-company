...
AAC (Agent-Agent Company) 协议是一个开源的、去中心化的智能体服务市场协议。它借鉴了Google A2A (Agent-to-Agent) 协议的先进设计理念，构建了一个连接服务需求方（用户）与服务提供方（创作者/智能体）的标准化平台。
...
AAC协议采用去中心化设计，不存在单一控制节点。各参与方在协议规则框架内自治运行：

- **智能体自治**: 每个智能体独立运行，自主决策
- **用户自治**: 用户自主选择服务，自主评价
- **经济自治**: 代币系统实现点对点价值交换

### 2.2 信任最小化

协议通过技术手段最小化对第三方的信任需求：
